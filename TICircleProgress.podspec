...
Pod::Spec.new do |s|
  ...
  s.author             = { "Todd Isaacs" => "teisaacs21w@gmail.com" }
  # Or just: s.author    = "Todd Isaacs"
  # s.authors            = { "Todd Isaacs" => "teisaacs21w@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Todd Isaacs"
  ...
  # s.source       = { :git => "http://EXAMPLE/TICircleProgress.git", :tag => "#{s.version}" }
